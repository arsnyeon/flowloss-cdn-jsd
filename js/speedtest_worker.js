...
var settings = {
	...
	url_dl: "https://mirror.sjtu.edu.cn/speedtest/garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul: "https://mirror.sjtu.edu.cn/speedtest/empty.php", // path to an empty file, used for upload test. must be relative to this js file
	url_ping: "https://mirror.sjtu.edu.cn/speedtest/empty.php", // path to an empty file, used for ping test. must be relative to this js file
	url_getIp: "https://mirror.sjtu.edu.cn/speedtest/getIP.php", // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
	...
	var testStream = function(i, delay) {
		setTimeout(
			function() {
				...
				xhr[i].open("GET", settings.url_dl + url_sep(settings.url_dl) + (settings.mpot ? "cors=true&" : "") + "vendor=FlowLoss_Speed_Measuring_Tool" + "&r=" + Math.random() + "&ckSize=" + settings.garbagePhp_chunkSize, true); // random string to prevent caching
				xhr[i].send();
			}.bind(this),
			1 + delay
		);
